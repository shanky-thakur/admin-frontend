      ...
      <div style={{ height: "90%", width: "100%", display: "flex", justifyContent: "space-evenly", alignItems: "center" }}>
        ...
        <div style={{ width: "20%", height: "100%", border: "1px solid #EAEAEA", background: "#FFF", borderRadius: "25px" }}>
          ...
          <div style={{ height: "100%", width: "100%" }}>
            ...
            <div style={{ width: "100%", height: "70%", display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }}>
              ...
              <div onClick={() => navigate('/employee')} className='element' style={{ width: "70%", height: "10%", display: "flex", justifyContent: "center", alignItems: "center", borderRadius: "20px", border: "none" }}>
              ...
              <div className='element' style={{ background: "#101010", width: "70%", height: "10%", display: "flex", justifyContent: "center", alignItems: "center", borderRadius: "20px", border: "none" }}>
                <div onClick={() => navigate('/students')} className='innerElement' style={{ fontFamily: "Lufga", fontSize: "16px", color: "#FFF", fontWeight: "400" }}>
                  Students
                </div>
              </div>
        ...
        <div style={{ width: "80%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }}>
          ...
          <div style={{ width: "85%", height: "12%", display: "flex", alignItems: "center" }}>
            ...
            <div onClick={() => navigate('/add/employee')} style={{ width: "20%", height: "65%", border: "1px solid #EAEAEA", color: "#374957", fontFamily: "Lufga", fontSize: "15px", fontWeight: "400", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "25px" }}>Employee</div>

            <div style={{ width: "2%", height: "75%" }}></div>

            <div style={{ fontFamily: "Lufga", width: "20%", height: "65%", display: "flex", alignItems: "center", justifyContent: "center", background: "#FFD600", color: "#000", border: "1px solid #EAEAEA", borderRadius: "25px", fontSize: "15px", fontWeight: "400" }}>Students</div>
          ...
          <div style={{ width: "75%", height: "73%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-evenly" }}>
            ...
            <div onClick={() => navigate('/students')} style={{ width: "100%", height: "12%", background: "#000", borderRadius: "25px", display: "flex", alignItems: "center", justifyContent: "center", color: "#F3F6FF", fontFamily: "Lufga", fontWeight: "500", fontSize: "16px", cursor: "pointer" }}>Register</div>
