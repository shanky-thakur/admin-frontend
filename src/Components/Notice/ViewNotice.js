...
const ViewNotice = () => {
  ...
  const NoticeCard = ({ name }) => {
    return (
      <div style={{ width: "95%", height: "50px", border: "1px solid #EAEAEA", borderRadius: "25px", display: "flex", alignItems: "center", justifyContent: "space-evenly" }}>
        <div style={{ width: "5%", height: "85%", display: "flex", alignItems: "center", color: "#000", fontFamily: "Lufga", fontSize: "14px", fontWeight: "400" }}></div>
        <div style={{ width: "45%", height: "85%", display: "flex", alignItems: "center", color: "#000", fontFamily: "Lufga", fontSize: "14px", fontWeight: "400" }}>
          {name}
        </div>
        <div onClick={() => navigate('/notice/view')} style={{ width: "40%", height: "85%", display: "flex", alignItems: "center", justifyContent: "end", color: "#FFD600", fontFamily: "Lufga", fontSize: "14px", fontWeight: "500", cursor: "pointer" }}><u>View Notice</u></div>
        <div style={{ width: "5%", height: "85%", display: "flex", alignItems: "center", color: "#000", fontFamily: "Lufga", fontSize: "14px", fontWeight: "400" }}></div>
      </div>
    )
  }
    ...
    <div style={{ width: "80vw", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
      ...
      <div style={{ height: "90%", width: "100%", display: "flex", justifyContent: "space-evenly", alignItems: "center" }}>
        ...
        <div style={{ width: "80%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }}>
          ...
          <div style={{ width: "90%", height: '80%', display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ width: "20%", height: "100%", border: "2px solid #EAEAEA", borderRadius: "25px", background: "#FFF", flexDirection: "column", display: "flex", alignItems: "center", justifyContent: "space-around" }}>
              ...
              <div style={{ width: "90%", height: "30%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-evenly" }}>
                ...
                <div onClick={() => navigate('/notice')} style={{ width: "90%", height: "45%", color: "#374957", fontFamily: "Lufga", fontSize: "14px", fontWeight: "400", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  Create Notice
                </div>

                <div style={{ width: "90%", height: "35%", borderRadius: "18px", background: "#101010", color: '#FFF', fontFamily: "Lufga", fontWeight: "400", fontSize: "14px", display: "flex", alignItems: "center", justifyContent: "center" }}>View Notice</div>
            ...
            <div style={{ width: "78%", height: "100%", border: "2px solid #EAEAEA", borderRadius: "25px", background: "#FFF", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ width: "85%", height: "75%", borderRadius: "25px", overflow: "auto" }}>

                <div style={{ overflow: "auto", display: "grid", gridTemplateColumns: "repeat(1, 1fr)", gap: "5px" }}>

                  {noticeInfo.map((notice, index) => (
                    <NoticeCard name={notice.name} key={index}/>
                  ))}
